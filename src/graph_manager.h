...
class GraphManager : public QObject {
    ...
    public Q_SLOTS:
      ...
      void firstnode_afterswitch();  //lligen added
    ...
    void save_A_CloudsToFile(QString filename);
    void save_A_Clouds(QString file_basename, bool threaded=true);
...
protected:
    ...
    QList<int> cam2_has_ID_in_graph;
    QList<QMatrix4x4> cam2_poses_ralative_to_cam1;
    bool firstnode_afs;
