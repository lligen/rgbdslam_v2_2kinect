...
void printQMatrix4x4(const char* name, const QMatrix4x4& m){
    ROS_INFO("QMatrix %s:", name);
    ROS_INFO("%f\t%f\t%f\t%f", m(0,0), m(0,1), m(0,2), m(0,3));
    ROS_INFO("%f\t%f\t%f\t%f", m(1,0), m(1,1), m(1,2), m(1,3));
    ROS_INFO("%f\t%f\t%f\t%f", m(2,0), m(2,1), m(2,2), m(2,3));
    ROS_INFO("%f\t%f\t%f\t%f", m(3,0), m(3,1), m(3,2), m(3,3));
}
...
void printTransform(const char* name, const tf::Transform t) {
    ...
    //save data
    std::ofstream ocout;
    ocout.open("test.txt",std::ios::out|std::ios::app);
    ocout<<t.getOrigin().x() << " " << t.getOrigin().y() << " " << t.getOrigin().z()<<"\n"
