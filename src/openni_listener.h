...
typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, 
                                                        ...
                                                        sensor_msgs::Image,  //lligen revised
                                                        sensor_msgs::Image,
...
class OpenNIListener : public QObject {
  ...
  public:
    ...
    void noCloudCallback (const sensor_msgs::ImageConstPtr& visual_img_msg,
                          ...
                          const sensor_msgs::ImageConstPtr& depth_img_msg2,     //lligen revised
  ...
  protected:
    ...
    //lligen added
    message_filters::Subscriber<sensor_msgs::Image> *visua_sub2_;
    message_filters::Subscriber<sensor_msgs::Image> *depth_sub2_;
    message_filters::Subscriber<sensor_msgs::CameraInfo> *cinfo_sub2_;
    BagSubscriber<sensor_msgs::Image>* rgb_img_sub2_;
    BagSubscriber<sensor_msgs::Image>* depth_img_sub2_;
    BagSubscriber<sensor_msgs::CameraInfo>* cam_info_sub2_;
    bool found_loopclosure;
    cv::Mat depth_mono8_img2_;
    int cam_id;
    cv::Ptr<cv::FeatureDetector> detector_2;
    cv::Ptr<cv::DescriptorExtractor> extractor_2;
    bool cam_needswitch_;
    Node* node_copy;
    Node* node2_copy;
    bool working_cam;//cam1 = 0  cam2=1
    bool few_feature;
